...
struct Localize {
    ...
    static let livingRoom = NSLocalizedString("Living Room", comment: "#bc-ignore!")
    ...
    static let diningRoom = NSLocalizedString("Dining Room", comment: "#bc-ignore!")
    static let homeOffice = NSLocalizedString("Home Office", comment: "#bc-ignore!")
    static let laundryRoom = NSLocalizedString("Laundry Room", comment: "#bc-ignore!")
    ...
    static let guestRoom = NSLocalizedString("Guest Room", comment: "#bc-ignore!")
    ...
    static let studyRoom = NSLocalizedString("Study Room", comment: "#bc-ignore!")
    ...
    static let homeTheater = NSLocalizedString("Home Theater", comment: "#bc-ignore!")
    static let workshop = NSLocalizedString("Workshop", comment: "#bc-ignore!")
    static let storageRoom = NSLocalizedString("Storage Room", comment: "#bc-ignore!")
